...
run_once("urxvtd")                              -- urxvt daemon
run_once("udiskie")                             -- handle auto mount
-- run_once("compton")                          -- transparency
run_once("unclutter -idle 10")                  -- hide cursor after 10s
run_once("xflux -l 48.8566 -g 2.3522")          -- ambiant light Paris
...
for s = 1, screen.count() do
   tags[s] = awful.tag(tags.names, s, layouts[6])
end
-- }}}
